...
export default function PteRepeatSentencePage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            reader.onloadend = async () => {
                ...
                const testInput: PteRepeatSentenceInput = { originalSentence: currentSentence.text, audioDataUri: base64Audio };
                const scoreResult = await scorePteRepeatSentence(testInput);
    ...
    const handleNext = () => {
        ...
        setResult(null);
        setAudioUrl(null);
        setCurrentSentenceIndex((prev) => (prev + 1) % pteRepeatSentenceData.length);
    };
    ...
    return (
        <div className="w-full">
            <div className="mx-auto max-w-4xl space-y-4">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="text-3xl font-headline">PTE Speaking: Repeat Sentence</CardTitle>
                        <CardDescription>You will hear a sentence. Please repeat the sentence exactly as you hear it.</CardDescription>
                    </CardHeader>
                    <CardContent>
